...
var Layout = function() {
    ...
    var layoutImgPath = 'layouts/leftsider/img/';

    var layoutCssPath = 'layouts/leftsider/css/';
    ...
    return {
        ...
        init: function () {            
           // this.initHeader(); //delete by chenkanghua
            this.initSidebar();
            //this.initContent(); //delete by chenkanghua
            this.initFooter();
        },
