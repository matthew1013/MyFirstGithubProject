...
<link href="/assets/pages/css/pro-detail.css" rel="stylesheet" type="text/css" />
                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption font-dark">
                                <i class=" icon-list"></i>
                                <span class="caption-subject uppercase">申请大牛详情</span>
                            </div>
                        </div>
...
<script id="item-tmpl" type="html/x-jsrender">
...
<div class="base-info">
	...
	<div class="row margin-top-30">
	    ...
	    <div class="col-md-6 col-sm-6 col-xs-12">
	       	<input type="text" name="realname" placeholder="请输入您的真实姓名" disabled="disabled" value="{{:realname}}" class="form-control radius0"/>
	    </div>
	   ...
	   <div class="row margin-top-30">
	    ...
	    <div class="col-md-9 col-sm-9 col-xs-12">
	    	<div class="sex-list">
	        	<div class="sex">
					<input type="radio" name="sex" value="1" disabled = "disabled" {{if sex==1}}checked{{/if}}>
					男性 
				</div>
				<div class="sex margin-left-21">
					<input type="radio" name="sex" value="2" disabled = "disabled" {{if sex==2}}checked{{/if}}>
					女性
				</div>
				<div class="sex margin-left-21">
					<input type="radio" name="sex" value="3" disabled = "disabled" {{if sex==3}}checked{{/if}}>
					保密
				</div>
             </div>
	    </div>
	        ...
	        <div class="row upload-list">
				<div class="item row">
					<div class="col-md-5 col-sm-5 col-xs-12">
						<a href="{{:idUpload}}" class="title" data-id="{{:idUpload}}">{{:idUploadName}}</a>
					</div>
...
<div class="pro-info">
	...
	<div class="row margin-top-30">
	    ...
	    <div class="col-md-3 col-sm-3 col-xs-5">
	    	<select name="proType" class="form-control radius0" disabled = "disabled">
	            <option value="">请选择领域分类</option>
	             <option value="1"  {{if sex==1}}selected{{/if}}>学术</option>
				<option value="2"  {{if sex==2}}selected{{/if}}>学习与工作</option>
				<option value="3"  {{if sex==3}}selected{{/if}}>生活娱乐</option>
	      	</select>
	    </div>
	 	<div class="col-md-4 col-sm-4 col-xs-6"> 
	 		<select name="pro" class="form-control radius0" style="margin-left:15px"  disabled = "disabled">
	   ...
	   <div class="row margin-top-30">
	     <div class="col-md-2 col-sm-2 col-xs-12">
	      ...
	      <div class="col-md-10 col-sm-10 col-xs-12">
	          <textarea type="text" rows="6" name="reason"  disabled = "disabled" placeholder="请输入申请理由" class="form-control radius0">{{:reason}}</textarea>
	     </div>
	  </div>
	   ...
	   <div  class="row margin-top-30 education-upload">
	    ...
	    <div class="col-md-10 col-sm-10 col-xs-12">
	        <div class="row upload-list">
	        	<div class="item row">
					<div class="col-md-5 col-sm-5 col-xs-12">
						<a href="{{:educationUpload}}" class="title" data-id="{{:educationUpload}}">{{:educationUploadName}}</a>
					</div>
					<!-- <div class="col-md-5 col-sm-5 col-xs-5">
						<a href="javascript:void(0);" class="glyphicon glyphicon-remove delete"></a>
					</div> -->
	...
	<div  class="row margin-top-30 other-upload">
	    ...
	    <div class="col-md-10 col-sm-10 col-xs-12">
	        <div class="row upload-list">
	        	<div class="item row">
					<div class="col-md-5 col-sm-5 col-xs-12">
						<a href="{{:otherUpload}}" class="title" data-id="{{:otherUpload}}">{{:otherUploadName}}</a>
					</div>
					<!-- <div class="col-md-5 col-sm-5 col-xs-5">
						<a href="javascript:void(0);" class="glyphicon glyphicon-remove delete"></a>
					</div> -->
...
<div class="pay row">
	...
	<div class="row info">
		<span class="desc">您申请的大牛专业领域为：<span class="active">{{:proUser.realm}}</span>，Anyonehelps 将在24小时内对您提交的资料进行审核，如需帮助，您可以拨打专线电话<span class="active">(626) 662-2748</span>，或者发送邮件至<span class="active">help@anyonehelps.com</span>，更多信息请点击《<a target="_blank" href="/agreement/pro.jsp"><span class="active">Anyonehelps申请专业大牛服务说明</span></a>》，祝好！</span>
	</div>
	<div class="row">
...
<script src="/assets/pages/scripts/pro-detail.js" type="text/javascript"></script>
