...
<link href="/assets/pages/css/task-multiplex.css" rel="stylesheet" id="style_components" type="text/css" />    
                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject uppercase">任务复用(原来任务内容)</span>
			...
			<div style="float:left;">
				<ul class="nav nav-tabs">
            		...
            		<li {{if #index == 0 }} class="active" {{/if}}>
               		 	<a href="#tab_1_{{: #getIndex()}}" data-toggle="tab">{{:name}}</a>
                	</li>
					{{/for}}
...
<script src="/assets/pages/scripts/task-multiplex.js" type="text/javascript"></script>
