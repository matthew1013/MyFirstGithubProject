...
<link href="/assets/pages/css/task-accepted-list.css" rel="stylesheet" type="text/css" />
                    ...
                    <div class="portlet light bordered">
						<div class="portlet-title">
							...
							<ul class="nav nav-tabs">
                            	<li class="task-state" data-state="0">
                                 	<a href="#tab_1_0" data-toggle="tab">所有</a>
                           		</li>
                           		<li class="task-state" data-state="1">
                                 	<a href="#tab_1_1" data-toggle="tab">匹配中</a>
                           		</li>
                                <li class="task-state active" data-state="2">
                                	<a href="#tab_1_2" data-toggle="tab">进行中</a>
                                </li>
...
<div class="task-item" data-open="{{:open}}"  data-id="{{:id}}"> 
	...
	<!-- <div class="row title {{if open==0}}bg-gray{{/if}}">
		...
		<div class="col-xs-3 col-sm-3 col-dm-3 col-lg-3">
			<ul>
				<li><a href="javascript:;" class="zoom up" title="展开"><i class="glyphicon glyphicon-chevron-left"></i><span>展开</span></a></li>
         		<li><a href="/dashboard/Finance/records.jsp?taskId={{:receiveDemands[0].demandId}}" class="record" target="_blank" title="任务财务记录"><i class="iconfont icon-finance-records"></i></a></li>
          		{{if state==0||state==1}}<li><a herf="javascript:;" class="modify-amount" title="修改任务报价" taskamount="{{:amount}}" amount="{{:receiveDemands[0].amount}}" data-id="{{:receiveDemands[0].id}}"><i class="iconfont icon-task-add"></i></a></li>{{/if}}
          		<li><a herf="javascript:;" class="remark" title="任务备忘录" remark="{{:receiveDemands[0].remark}}"  data-id="{{:receiveDemands[0].id}}"><i class="iconfont icon-task-arbitration"></i></a></li>
     		</ul>
		</div>
 	</div> -->
    <div class="row info">
		<span class="hidden-xs">任务编号：</span><span class="hidden-xs">{{:id}}</span>
      	<span class="expire-date">截止时间：</span><span>{{:expireDate}}</span>
		<span class="my-amount">我的报价：</span><span>\${{:receiveDemands[0].amount}}</span>	
  	</div>
	<div class="row content hide">
		{{:content}}
	</div>

	<div class="row achieve margin-top-10 hide">
	...
	<!--haokun added 2017/03/06 start 增加私密成果要求-->
	...
	<!--haokun added 2017/03/06 end 增加私密成果要求-->

	{{if enclosure1}}
	<div class="enclosure row hide">
		<span>附件:</span>
		<ul>
		{{if enclosure1}}
	...
	<div class="row specialty hide">
		...
		<div class="right">
			<ul>
         		<li><a href="/dashboard/Finance/records.jsp?taskId={{:receiveDemands[0].demandId}}" class="record" target="_blank" title="任务财务记录"><i class="iconfont icon-task-finance"></i></a></li>
          		{{if state==0||state==1}}<li><a herf="javascript:;" class="modify-amount" title="修改任务报价" taskamount="{{:amount}}" amount="{{:receiveDemands[0].amount}}" data-id="{{:receiveDemands[0].id}}"><i class="iconfont icon-task-add"></i></a></li>{{/if}}
          		<li><a herf="javascript:;" class="remark" title="任务备忘录" remark="{{:receiveDemands[0].remark}}"  data-id="{{:receiveDemands[0].id}}"><i class="iconfont icon-note"></i></a></li>
			</ul> 
		</div>
 	</div>

	<div class="line margin-top-20 hide"></div>
	...
	<div class="row achieve-receive hide">
		...
		<div class="row">
			<pre>{{:receiveDemands[0].resultDesc}}</pre>
		</div>
		{{if receiveDemands[0].resultUrl1}}
		<div class="enclosure row">
			<span>附件：</span>
			<ul>
			{{if receiveDemands[0].resultUrl1}}
				<li><a href="{{:receiveDemands[0].resultUrl1}}" target="_blank">{{:receiveDemands[0].resultUrl1Name}}</a></li>
			{{/if}}
			{{if receiveDemands[0].resultUrl2}}
				<li><a href="{{:receiveDemands[0].resultUrl2}}" target="_blank">{{:receiveDemands[0].resultUrl2Name}}</a></li>
			{{/if}}
			{{if receiveDemands[0].resultUrl3}}
				<li><a href="{{:receiveDemands[0].resultUrl3}}" target="_blank">{{:receiveDemands[0].resultUrl3Name}}</a></li>
			{{/if}}
			{{if receiveDemands[0].resultUrl4}}
				<li><a href="{{:receiveDemands[0].resultUrl4}}" target="_blank">{{:receiveDemands[0].resultUrl4Name}}</a></li>
			{{/if}}
			{{if receiveDemands[0].resultUrl5}}
				<li><a href="{{:receiveDemands[0].resultUrl5}}" target="_blank">{{:receiveDemands[0].resultUrl5Name}}</a></li>
			{{/if}}
			</ul>
		</div>
		{{/if}}
	</div> 
	<div class="line margin-top-10 hide"></div>
	{{/if}}

	{{if receiveDemands[0].state == "1" && receiveDemands[0].rulePercent}}
		<div class="row arbitration hide">
			<div>
				<div class="arbitration-tip">
					<span>平台仲裁：</span>
				</div>
				<div class="row star">
					<span class="desc">仲裁比例: {{:receiveDemands[0].rulePercent}}%</span>
				</div>
				<div class="row star">
					<span class="desc">仲裁描述:</span>
					<pre>{{:receiveDemands[0].ruleReason}}</pre>
				</div>
			</div>
		</div> 
		<div class="line margin-top-10 hide"></div>
	...
	{{if receiveDemands[0].evaluate}}
	<div class="row evaluate hide">
		<div>
			...
			<div class="row star">
				<span class="desc">诚信打分:</span>
				<input type="number" value="{{:receiveDemands[0].evaluate.evaluate}}" class="rating" min=0 max=5 step=0.5 data-size="sm" data-show-clear="false" data-displayonly="true" data-disabled="true">
			</div>
			<div class="row star">
				<span class="desc">质量打分:</span>
				<input type="number" value="{{:receiveDemands[0].evaluate.quality}}" class="rating" min=0 max=5 step=0.5 data-size="sm" data-show-clear="false" data-displayonly="true" data-disabled="true">
			</div>
			<div class="row star">
				<span class="desc">准时性打分:</span>
				<input type="number" value="{{:receiveDemands[0].evaluate.punctual}}" class="rating" min=0 max=5 step=0.5 data-size="sm" data-show-clear="false" data-displayonly="true" data-disabled="true">
			</div>
			<div class="row star">
				<span class="desc">评价描述:</span>
				<pre>{{:receiveDemands[0].evaluate.description}}</pre>
			</div>
		</div>
	</div> 
	<div class="line margin-top-10 hide"></div>
	...
	{{if receiveDemands[0].evaluateReceiver}}
	<div class="row evaluate hide">
		<div>
			<div class="evaluate-tip">
				<span>我的评价：</span>
			...
			<div class="row star">
				<span class="desc">诚信打分:</span>
				<input type="number" value="{{:receiveDemands[0].evaluateReceiver.evaluate}}" class="rating" min=0 max=5 step=0.5 data-size="sm" data-show-clear="false" data-displayonly="true" data-disabled="true">
			</div>
			<div class="row star">
				<span class="desc">评价描述:</span>
				<pre>{{:receiveDemands[0].evaluateReceiver.description}}</pre>
			</div>
		</div>
	</div> 
	<div class="line margin-top-10 hide"></div>
	...
	<div class="row operate">
		...
		<div class="right">
			<ul>
				<li>
					<button type="button" class="btn zoom up">展开任务</button>
				</li>
				<li  class="{{if state==="6" && receiveDemands[0].state === "1" &&　receiveDemands[0].payState === "2"}}{{else}}hide{{/if}}">
					<button class="btn task-pay" data-rdid="{{:receiveDemands[0].id}}" data-id="{{:id}}">收款</button>
				</li>
				<li  class="{{if state==="7" && receiveDemands[0].state === "1"}}{{else}}hide{{/if}}">
					<button class="btn task-pay" data-rdid="{{:receiveDemands[0].id}}" data-id="{{:id}}">查看仲裁</button>
				</li>
				<li  class="{{if state === "8" && receiveDemands[0].evaluateStateReceiver =="0"}}{{else}}hide{{/if}}">
					<button class="btn task-evaluate" data-id={{:id}}>评价</button>
				</li>
				<li  class="{{if state === "0" || if state === "1"}}{{else}}hide{{/if}}">
					<button class="btn task-cancel" data-id={{:id}}>取消投标</button>
				</li>
				<li  class="{{if state === "2" && receiveDemands[0].state =="1"}}{{else}}hide{{/if}}">
					<button class="btn task-start"  data-id={{:id}}>开始任务</button>
				</li>
				<!--haokun added 2017/03/10 start 增加任务匹配后接单人能够拒绝任务，任务状态重新返回到匹配中,给发单人发送提示-->
				<li  class="{{if state === "2" && receiveDemands[0].state =="1"}}{{else}}hide{{/if}}">
					<button class="btn task-refuse" data-id={{:id}}>拒绝任务</button>
				</li>				
				<!--haokun added 2017/03/10 end 增加任务匹配后接单人能够拒绝任务，任务状态重新返回到匹配中,给发单人发送提示-->
				<li  class="{{if state === "3" && receiveDemands[0].state =="1"}}{{else}}hide{{/if}}">
					<button class="btn task-complete" data-id={{:id}}>提交成果</button>
				</li>
				<!--haokun added 2017/03/14 start 增加任务开始后接单人能够终止任务；点击“终止任务”后，也是到达提交任务成果；功能和提交成果一样-->
				<li  class="{{if state === "3" && receiveDemands[0].state =="1"}}{{else}}hide{{/if}}">
					<button class="btn task-complete" data-id={{:id}}>终止任务</button>
				</li>				
	...
	<!-- <div class="row operate">
		{{if da.length>0}}
		<button type="button" class="btn show-attach {{if open==0}}bg-gray{{/if}}">显示附加任务</button>
		{{/if}}
		<button type="button" class="btn task-pay {{if state==="6" && receiveDemands[0].state === "1" &&　receiveDemands[0].payState === "2"}}{{else}}hide{{/if}}{{if open==0}}bg-gray{{/if}}"  
			data-rdid="{{:receiveDemands[0].id}}" data-id="{{:id}}">收款</button>
		<button type="button" class="btn task-pay {{if state==="7" && receiveDemands[0].state === "1" &&　receiveDemands[0].payState === "4"}}{{else}}hide{{/if}} {{if open==0}}bg-gray{{/if}}"  
			data-rdid="{{:receiveDemands[0].id}}" data-id="{{:id}}">查看仲裁</button>
		<button type="button" class="btn task-evaluate {{if state === "8" && receiveDemands[0].evaluateStateReceiver =="0"}}{{else}}hide{{/if}} {{if open==0}}bg-gray{{/if}}" data-id={{:id}}>评价</button>
		<button type="button" class="btn task-cancel {{if state === "0" || if state === "1"}}{{else}}hide{{/if}} {{if open==0}}bg-gray{{/if}}" data-id={{:id}}>取消投标</button>
		<button type="button" class="btn task-start {{if state === "2" && receiveDemands[0].state =="1"}}{{else}}hide{{/if}} {{if open==0}}bg-gray{{/if}}" data-id={{:id}}>开始任务</button>
		<button type="button" class="btn task-complete {{if state === "3" && receiveDemands[0].state =="1"}}{{else}}hide{{/if}} {{if open==0}}bg-gray{{/if}}" data-id={{:id}}>提交成果</button>
	</div> -->
</div>
{{/for}}
</script>
...
<script src="/assets/global/plugins/jquery-file-upload/js/jquery.fileupload-validate.js" type="text/javascript"></script>
	...
	<script src="/assets/pages/scripts/task-accepted-list.js" type="text/javascript"></script>
