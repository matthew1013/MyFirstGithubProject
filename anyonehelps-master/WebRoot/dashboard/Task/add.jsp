...
<link href="/assets/global/plugins/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css"  data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-458" data-genuitec-path="/anyonehelps-master/WebRoot/dashboard/Task/add.jsp"/>
...
<link href="/assets/pages/css/task-add.css" rel="stylesheet" type="text/css" />
<link href="/assets/global/plugins/bootstrap-toastr/toastr.min.css" rel="stylesheet" type="text/css" />
	...
	<input type="hidden" value="${param.proUserId}" name="proUserId"/>
                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject uppercase">新发任务</span>
                                <span class="caption-helper"><i class="fa fa-minus-circle" style="color:red"></i>：请明确任务成果要求，如发生纠纷，平台将跟据交易达成时所述要求进行仲裁！</span>  <!--haokun modified 2017/03/01 修改标志-->
                            </div>
                            <!-- 
                            <div class="actions">
                        ...
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->
                            <form action="#" class="form-horizontal" id="task-form">
                            
                            	<div class="row margin-top-30">
		                           	<span class="step">1</span>
		                           	<span class="step-desc font-plus"><b>任务类型</b><span>    <!--haokun modified 2017/03/01 改为任务类型-->
		                        </div>
								
								<!--haokun modified 2017/03/07 start 修改-->
                            	<div class="row margin-top-10">
		                            ...
		                            <div class="col-md-7 col-sm-7 col-xs-10">
		                            	<div class="col-md-4 col-sm-4 col-xs-5">
		                                	<select id="type" class="form-control radius0">   <!--haokun modified 2017/03/01 去掉radius0-->
	                                        	<option value="">其它</option>   <!--haokun modified 2017/03/01 改为其他-->
	                                            <option value="1">学术</option>
												<option value="2">生活</option>     <!--haokun modified 2017/02/27-->
												<option value="3">工作</option>     <!--haokun modified 2017/02/27-->
	                                        </select>
		                                </div>
										<div class="col-md-1 col-sm-1 col-xs-1" >    <!--haokun modified 2017/03/07-->
		                                </div>
		                                <div class="col-md-4 col-sm-4 col-xs-5" >   
		                                	<select id="typeSecond" class="form-control radius0">   <!--haokun modified 2017/03/01 去掉radius0-->
	                                          	<option value=""><b>请选择分类</b></option>
	                                       	</select>
		                                </div>
										
										<!--haokun modified 2017/03/01 start 标签修改-->
	                        	        <div class="margin-top-30 ">
		                        	        <div class="left">
                            			      &nbsp;
	                                        </div>
	                                        <div class="col-md-10 col-sm-10 col-xs-12">     <!--haokun modified 2017/03/07-->
	                        	        ...
	                        	        <div class="margin-top-10 ">
		                         	        ...
		                         	        <div class="col-md-9 col-sm-9 col-xs-12">
		                            	       <input type="text" class="form-control radius0" placeholder="请输入标签，如有多个，请使用#号分开" name="tag">
		                        	        </div>
		                    	        </div>
									...
									<div class="right-safe-icon col-md-3 col-sm-3 col-xs-0">     <!--haokun modified 2017/03/13 宽度从4变成3 -->
									    <div class="title"><center>免费发布任务!<center></div>  <!--haokun modified 2017/03/13 文字改变 -->
									    <div class="content">
								...
								<!--haokun modified 2017/03/07 end 修改-->	
								

								
                            
							    <!--  haokun deleted 2017/03/01   删除这部分
                            	<div class="row margin-top-30">
		                           	<span class="step">2</span>
		                           	<span class="step-desc font-plus">请简要概括您要发布的任务<span>
		                        </div>
		                        -->
								
								<!--haokun modified 2017/03/13 start 增加了”60字“，增加了”col-md, col-sm, col-xs“-->
								<div class="row margin-top-30">   
								  <div class="col-md-8 col-sm-8 col-xs-10">
		                           	<span class="step">2</span>
		                           	<span class="step-desc font-plus"><b>任务标题</b><span class="font-red-flamingo">*</span><span class="task-title-alert hide">必填：请输入任务标题</span></span> 
		                           	<span class="step-desc pull-right"><span class="title-limit-count">60</span>字</span>
                                  </div>
		                        </div>
								<!--haokun modified 2017/03/13 end 增加了”还可以输了60“，增加了”col-md, col-sm, col-xs“-->
		                        ...
		                        <div class="row margin-top-10">       
	                                ...
	                                <div class="col-md-10 col-sm-10 col-xs-10">
		                        		<span class="step-desc">任务标题<span class="font-red-flamingo">*</span><span>  
		                           		<span class="step-desc pull-right">还可以输入<span class="title-limit-count">60</span>字</span>
	                              	</div>
		                        </div>
								-->
		                        ...
		                        <div class="row margin-top-10">   
	                                ...
	                                <div class="left">
	                                 ...
	                                 <div class="col-md-8 col-sm-8 col-xs-10">    <!--haokum modified 2017/03/13 修改了col-md和col-sm，数值从10改成8-->
		                        		<input type="text" class="form-control radius0" placeholder="请输入任务标题" name="title" maxlength="60">
	                              	</div>
	                        	</div>
		                            ...
		                            <div class="col-md-10 col-sm-10 col-xs-10">
		                                <div class="share-location">
		                                	<div style="float:left;">
		                                		<input type="checkbox" name="location-open">
								...
								<!--
                             	<div class="row margin-top-10">
	                                ...
	                                <div class="col-md-10 col-sm-10 col-xs-10">
		                        		<span class="step-desc">任务描述<span class="font-red-flamingo">*</span><span>
	                              	</div>
		                        </div>
								-->
								
								<div class="row margin-top-30">    <!--haokun added 2017/03/01-->
		                           	<span class="step">3</span>
		                           	<span class="step-desc font-plus"><b>任务描述</b><span>
		                        </div>
		                        
		                        <div class="row margin-top-10">                  <!--haokun added 2017/03/01 margin-top-10 -->
	                          		<div class="left">
                            			&nbsp;
	                                </div>
	                                <div class="col-md-10 col-sm-10 col-xs-10">
								...
								<!--   haokun deleted 2017/03/01
	                        	<div class="row margin-top-10">
		                        	<div class="left">
                            			&nbsp;
	                                </div>
	                                <div class="col-md-10 col-sm-10 col-xs-10">
		                        		<span class="step-desc font-red-flamingo">成果要求*<span>
	                              	</div>
		                        </div>
								-->
								<div class="row margin-top-30">    <!--haokun added 2017/03/01-->
		                           	<span class="step">4</span>
		                           	<span class="step-desc font-plus"><b>成果要求</b><span class="font-red-flamingo">*</span><span class="task-achieve-alert hide">必填：请输入成果要求<span><span><!--haokun added 2017/03/01 增加错误提示-->
		                        </div>
	                        	...
	                        	<div class="row margin-top-10">   <!--haokun added 2017/03/01 margin-top-10 -->
	                                ...
	                                <div class="col-md-10 col-sm-10 col-xs-10">
	                                	<textarea type="text" rows="6" placeholder="请输入成果要求" class="form-control radius achieve"></textarea></div>
	                        	</div>
								
								
								<!--haokun modified 2017/03/10 start 增加私密成果要求-->
	                            <div class="row margin-top-10 ">
		                        	<div class="left">
                            			&nbsp;
	                                </div>
	                        	...
	                        	<div class=" row margin-top-10 ">
		                         	...
		                         	<div class="col-md-10 col-sm-10 col-xs-10">
		                            	 <input type="text" class="form-control radius0 secret-achieve" placeholder="如果您有什么话想悄悄对中标人说，请输入..." name="secret-achieve">
		                        	</div>
		                    	</div>
								<!--haokun modified 2017/03/10 end 增加私密成果要求-->
	                        	
							    <!--    haokun deleted 2017/03/01
	                        	<div class="row margin-top-30">
		                           	<span class="step">3</span>
		                           	<span class="step-desc font-plus">请填写您的任务属性<span>
		                        </div>
								-->
		                        ...
		                        <div class="row margin-top-10">
	                                ...
	                                <div class="col-md-10 col-sm-10 col-xs-10">
		                        		<span class="step-desc">悬赏金额($)<span class="font-red-flamingo">*</span><span>
	                              	</div>
		                        </div>
								-->
								...
								<div class="row margin-top-30">    <!--haokun added 2017/03/01-->
		                           	...
		                           	<span class="step-desc font-plus"><b>悬赏金额</b><span class="font-red-flamingo">*</span><span class="task-amount-alert hide">必填：请输入悬赏金额<span><span>  <!--haokun added 2017/03/01 增加错误提示-->
		                        </div>
		                        ...
		                        <div class="row margin-top-10">    <!--haokun added 2017/03/01 margin-top-10 -->
	                                ...
	                                <div class="col-md-10 col-sm-10 col-xs-10">
	                                	<div class="col-md-5 col-sm-7 col-xs-12">
	                                		<input type="number" maxlength="10"  class="form-control radius0" id="amount" placeholder="格式：xx或者xx.xx，最低金额为10美金">
	                                	</div>
	                        	...
	                        	<div class="row margin-top-10">
	                                ...
	                                <div class="col-md-10 col-sm-10 col-xs-10">
		                        		<span class="step-desc">截止时间<span class="font-red-flamingo">*</span><span>
	                              	</div>
		                        </div>
								-->
								...
								<div class="row margin-top-30">    <!--haokun added 2017/03/01-->
		                           	...
		                           	<span class="step-desc font-plus"><b>截止时间</b><span class="font-red-flamingo">*</span><span class="task-expire-alert hide">必填：请输入截止时间<span><span><!--haokun added 2017/03/01 增加错误提示-->
		                        </div>
	                        	<div class="row margin-top-10">        <!--haokun added 2017/03/01 margin-top-10 -->
	                          		<div class="left">
                            			&nbsp;
	                                ...
	                                <div class="col-md-10 col-sm-10 col-xs-10">
	                                	<div class="col-md-5 col-sm-5 col-xs-12">
	                                		<input type="text" class="form-control radius0" id="expire-date" placeholder="格式：yyyy-mm-dd hh:mm:ss">
	                                	</div>
	                              	</div>
	                        	</div>
		                           	...
		                           	<div class="col-md-10 col-sm-10 col-xs-10">
		                                ...
		                                <div class="row">
		                                	<span class="btn enclosure-upload fileinput-button">
	                                            <span> 上传文件 </span>
	                                            <input type="file" name="files[]" data-url="/demand/enclosure_upload">  <!--haokun delete multiple-->
	                                       	 </span>
		                        ...
		                        <div class="detail hide">
	                        		...
	                        		<div class="row margin-top-10">
		                                ...
		                                <div class="col-md-10 col-sm-10 col-xs-10">
		                                	<input type="checkbox" name="private-task"><span class="caption-helper" style="margin-left:10px;">如勾选，则任务不公开，任务不在首页显示，需要自己手动邀请用户来接任务</span>
		                              	</div>
		                        	</div>
                            	...
                            	<!-- <div class="row margin-top-30">
		                          	<div class="div-left">
		                               	<span class="left"><span class="step">1</span>任务类型<span class="font-red-flamingo">*</span>：</span>
		                            </div>
		                            <div class="col-md-10 col-sm-10 col-xs-10">
		                            	<div class="col-md-3 col-sm-3 col-xs-3">
		                                	<select id="type" class="form-control radius0">
	                                            ...
	                                            <option value="1">学术</option>
												<option value="2">学习和工作</option>
												<option value="3">生活娱乐</option>
	                                        </select>
		                                </div>
		                                <div class="col-md-5 col-sm-5 col-xs-5" style="padding-left:20px">
								...
								<div class="row margin-top-30">
	                          		<div class="div-left">
	                                	<span class="left"><span class="step">2</span>任务标题<span class="font-red-flamingo">*</span>：</span>
	                                </div>
	                                <div class="col-md-10 col-sm-10 col-xs-10">
		                        		<input type="text" class="form-control radius0" placeholder="请输入任务标题，60个字以内" name="title" maxlength="60">
	                              	</div>
	                        	</div>
	                        	
	                        	<div  class="row" style="margin-top:10px;">
		                          	<div class="div-left">
		                                <span class="left">分享位置：</span>
		                           	</div>
		                            <div class="col-md-10 col-sm-10 col-xs-10">
		                                <div class="share-location">
		                                	<div style="float:left;">
		                                		<input type="checkbox" name="location-open">
		                                		<span class="font-red-flamingo">本地定位服务</span>
		                                	</div>
	                        	...
	                        	<div class="row margin-top-30">
	                          		<div class="div-left">
	                                	<span class="left">任务描述<span class="font-red-flamingo">*</span>：</span>
	                                </div>
	                                <div class="col-md-10 col-sm-10 col-xs-10">
		                        		<div name="summernote" id="summernote_1"></div>
		                        		<div class="placeholder" style="display: block;">
	                        	...
	                        	<div class="row margin-top-20">
	                          		<div class="div-left">
	                                	<span class="left font-red-flamingo"><span class="step">3</span>成果要求<span class="font-red-flamingo">*</span>：</span>
	                                </div>
	                                <div class="col-md-10 col-sm-10 col-xs-10">
	                                	<textarea type="text" rows="6" placeholder="注意：请明确任务成果要求，如发生纠纷，平台将根据交易达成时所述要求进行仲裁。 一旦匹配后，将无法更改。&#13;&#10;如有多个成果要求，请按如下格式填写：&#13;&#10;1、成果要求1&#13;&#10;2、成果要求2" class="form-control radius achieve"></textarea>
	                              	</div>
	                        	</div>
	                        	
	                        	<div class="row margin-top-30">
	                          		<div class="div-left">
	                                	<span class="left">悬赏金额<span class="font-red-flamingo">*</span>：</span>
	                                </div>
	                                <div class="col-md-10 col-sm-10 col-xs-10">
	                                	<div class="col-md-6 col-sm-6 col-xs-6">
	                                		<input type="number" maxlength="10" min="0" step="1" class="form-control radius0" id="amount" placeholder="格式：xx或者xx.xx，最低金额为10美金">
	                                	</div>
	                                	<div class="col-md-2 col-sm-2 col-xs-2" style="padding-left:20px">
	                                		<span>余额:$</span><span class="usd-amount">0</span>
	                                	</div>
	                              	</div>
	                        	</div>
	                        	...
	                        	<div class="row margin-top-30">
	                          		<div class="div-left">
	                                	<span class="left">截止时间<span class="font-red-flamingo">*</span>：</span>
	                                </div>
	                                <div class="col-md-10 col-sm-10 col-xs-10">
		                          	...
		                          	<div class="div-left">
		                           	...
		                           	<div class="col-md-10 col-sm-10 col-xs-10">
		                                ...
		                                <div class="row">
		                                	<span class="btn enclosure-upload fileinput-button">
	                                            <span> 上传文件 </span>
	                                            <input type="file" name="files[]" data-url="/demand/enclosure_upload" multiple>
	                                       	 </span>
	                                       	 <label class="control-label font-red-flamingo" style="margin-left:10px;font-size: 10px;" id="enclosure-format">
												最大能上传5个附件，支持附件格式：gif、jpeg、png、doc、docx、pdf、jpg、bmp、png、ppt、pptx、xls、xlsx
											</label>
	                                 	</div>
		                         	</div>
		                        </div>
		                                ...
		                                <div class="col-md-10 col-sm-10 col-xs-10">
		                                	<div class="radio-list">
												...
												<div class="urgent margin-left-21">
													...
													加急<span class="caption-helper font-red-flamingo">(48小时内,金额不能低于10$)</span>
												</div>
												<div class="urgent margin-left-21">
													<input type="radio" name="urgent" value="2" >
													特急<span class="caption-helper font-red-flamingo">(24小时内,金额不能低于20$)</span>
												</div>
	                                         </div>
		                              	</div>
		                        	</div>
	                        	...
	                        	<div  class="row margin-top-30" >
	                                <div class="col-md-11 col-sm-11 col-xs-11">
	                                	<div>
	                                		<button onclick="window.location.href='/index.jsp'" class="btn reset-btn">取消</button>    <!--haokun modified 2017/02/17-->
    ...
    <div class="friend-item">
    	<div class="row"> 
			<div class="friend-item-title">
				<div class="title"><span>恭喜，任务发布成功！</span></div>
			</div>
			<div style="float:right;">
		...
		<div class="row">
			<div class="col-md-2 col-sm-2 col-xs-12"></div>
			<div class="col-md-8 col-sm-8 col-xs-12">
				<a href="javasrcipt:void(0)" class="search-user-a">
...
<script type="html/x-jsrender" id="specialty-tmpl">
    ...
    <div class="specialty-item">
    	<div class="row"> 
			...
			<div style="float:left;">
				<input type="text" class="form-control search" placeholder="关键字搜索" style="height: 28px;margin-top: 10px;margin-left: 50px;">
			</div>
			<div style="float:right;">
			...
			<div class="tab-content">
				{{for dataList}}
	         	<div class="tab-pane {{if #index==0}}active{{/if}}" id="tab_1_{{:#index}}">
					{{for specialtys}} 
						{{if #parent.parent.data.id==#parent.parent.getIndex()+1}}
						<button class="btn specialty-btn {{SpecialtyFormat id #parent.parent.parent.parent.parent.data.specialtyId/}}" type="button" data-id="{{:id}}" data-typeid="{{:#parent.parent.parent.data.id}}" data-name="{{:name}}">{{:name}}</button>
						{{/if}}
					{{/for}}
				</div>
				{{/for}}
...
<script id="pro-user-tmpl" type="html/x-jsrender">
{{if id !== "${user_id_session_key}"}}
<div class="row margin-top-30">
	<div class="pro-user" data-userid="{{:id}}">
		<div class="left">
			<span style="line-height: 50px;">求助大牛:</span>
		</div>
		<div class="left">
			<div class="pro-user-img">
				<a href="javascript:void(0);" class="user-pic" data-userid="{{:id}}">
					<img src="{{:picUrl}}">
				</a>
			</div>
		</div>
		<div class="right">
			...
			<div class="row margin-top-8">
				<div class="show-grade user-grade" data-grade="{{:grade}}" data-align="bottom left"><span>Lv{{calculateGrade grade/}}</span></div>
					<div class="pro-evaluate show-evaluate"  data-userid="{{:id}}" data-evaluatecount="{{:evaluateCount}}" data-evaluatepublishcount="{{:evaluatePublishCount}}" data-honest="{{:honest}}" data-quality="{{:quality}}" data-punctual="{{:punctual}}" data-honestpublish="{{:honestPublish}}" data-align="bottom left">
...
<script src="/assets/pages/scripts/task-add.js" type="text/javascript"></script>
